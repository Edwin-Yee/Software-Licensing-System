...
describe("RecommendationRequestsTable tests", () => {
  ...
  test("Has the expected column headers and content for ordinary user", () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <RecommendationRequestTable recrequests={recommendationRequestFixtures.threeRecommendationRequest} currentUser={currentUser} />
        </MemoryRouter>
      </QueryClientProvider>
  ...
  test("Delete button calls delete callback", async () => {
    ...
    expect(screen.getByTestId(`RecommendationRequestTable-cell-row-0-col-requesterEmail`)).toHaveTextContent("cgaucho1@ucsb.edu");
