...
public class RestaurantsController extends ApiController {
    ...
    public Restaurant postRestaurant(
        ...
        restaurant.setDepartment(department);
        restaurant.setLicenseAllocated(licenseAllocated);

        restaurant.setLicensePurchaseDate(licensePurchaseDate);
        restaurant.setEmail(email);
    ...
    public Restaurant updateRestaurant(
        ...
        restaurant.setEmail(incoming.getEmail());
